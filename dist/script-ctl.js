mw.loader.using([
	...
	(function(vue, _wikimedia_codex) {
		...
		var _hoisted_3 = { class: "smgr-header-actions" };
		var _hoisted_4 = { class: "smgr-body" };
		var _hoisted_5 = { key: 1 };
		var _hoisted_6 = { key: 2 };
		var _hoisted_7 = ["href"];
		var _hoisted_8 = { key: 0 };
		var _hoisted_9 = { key: 1 };
		var _hoisted_10 = { style: {
			"display": "flex",
			"gap": "8px",
			...
			setup(__props, { expose: __expose }) {
				...
				return (_ctx, _cache) => {
					return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [(0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxDialog), {
						open: is_open.value,
						"onUpdate:open": [_cache[6] || (_cache[6] = ($event) => is_open.value = $event), on_dialog_update],
						class: "smgr-dialog",
						...
						header: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", { class: (0, vue.normalizeClass)(["smgr-header-content", { "smgr-header-content--install": current_view.value === "install" }]) }, [current_view.value === "install" ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_1, [(0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxButton), {
							...
							default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxIcon), { icon: (0, vue.unref)(C7) }, null, 8, ["icon"]), _cache[10] || (_cache[10] = (0, vue.createTextVNode)("Back ", -1))]),
							_: 1
						}), _cache[11] || (_cache[11] = (0, vue.createElementVNode)("div", { class: "smgr-header-text" }, [(0, vue.createElementVNode)("span", { class: "cdx-dialog__header__title" }, "Install New Script")], -1))])) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_2, [..._cache[12] || (_cache[12] = [(0, vue.createElementVNode)("span", { class: "cdx-dialog__header__title" }, "script-ctl", -1), (0, vue.createElementVNode)("span", { class: "cdx-dialog__header__subtitle" }, "A security-focused user script manager", -1)])])), (0, vue.createElementVNode)("div", _hoisted_3, [current_view.value === "list" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(_wikimedia_codex.CdxButton), {
							key: 0,
							action: "progressive",
							weight: "primary",
							onClick: _cache[1] || (_cache[1] = ($event) => current_view.value = "install")
						}, {
							default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxIcon), { icon: (0, vue.unref)(C3) }, null, 8, ["icon"]), _cache[13] || (_cache[13] = (0, vue.createTextVNode)("Add script ", -1))]),
							_: 1
						})) : (0, vue.createCommentVNode)("", true), (0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxButton), {
							weight: "quiet",
							onClick: _cache[2] || (_cache[2] = ($event) => is_open.value = false),
							"aria-label": "Close"
						}, {
							default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxIcon), { icon: (0, vue.unref)(r4) }, null, 8, ["icon"]), _cache[14] || (_cache[14] = (0, vue.createTextVNode)("Close ", -1))]),
							_: 1
						})])], 2)]),
						default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_4, [notice.value.text ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
							key: 0,
							class: (0, vue.normalizeClass)(["smgr-notice", `smgr-notice--${notice.value.type}`])
						}, (0, vue.toDisplayString)(notice.value.text), 3)) : (0, vue.createCommentVNode)("", true), current_view.value === "install" ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_5, [(0, vue.createVNode)(InstallForm_default, {
							ref_key: "install_form_ref",
							ref: install_form_ref,
							busy: busy_install.value,
							onInstall: on_install_requested,
							onCancel: _cache[3] || (_cache[3] = ($event) => current_view.value = "list")
						}, null, 8, ["busy"])])) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_6, [(0, vue.createVNode)(ScriptList_default, {
							scripts: scripts.value,
							updates: updates.value,
							timestamps: timestamps.value,
							loading: loading.value,
							busy_idx: busy_idx.value,
							onToggle: _cache[4] || (_cache[4] = ($event) => on_toggle($event.idx, $event.current_status)),
							onUpdate: on_update,
							onUninstall: on_uninstall,
							onAdd_new: _cache[5] || (_cache[5] = ($event) => current_view.value = "install")
						}, null, 8, [
							"scripts",
							"updates",
							"timestamps",
						...
						"onUpdate:open": [_cache[8] || (_cache[8] = ($event) => show_warning.value = $event), _cache[9] || (_cache[9] = ($event) => show_warning.value = $event)],
						title: "Security Warning",
						"close-button-label": "Cancel",
						"use-close-button": true
					}, {
						footer: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_10, [(0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxButton), { onClick: _cache[7] || (_cache[7] = ($event) => show_warning.value = false) }, {
							default: (0, vue.withCtx)(() => [..._cache[21] || (_cache[21] = [(0, vue.createTextVNode)("Cancel", -1)])]),
							_: 1
						}), (0, vue.createVNode)((0, vue.unref)(_wikimedia_codex.CdxButton), {
							action: "destructive",
							weight: "primary",
						...
						default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("p", null, [
							_cache[15] || (_cache[15] = (0, vue.createElementVNode)("strong", null, "WARNING:", -1)),
							_cache[16] || (_cache[16] = (0, vue.createTextVNode)(" Userscripts could contain malicious content capable of compromising your account. You are expected to review the source code of the script before installing it: ", -1)),
							(0, vue.createElementVNode)("a", {
								href: get_url(pending_action.value.name),
								target: "_blank"
							}, [(0, vue.createElementVNode)("strong", null, (0, vue.toDisplayString)(pending_action.value.name), 1)], 8, _hoisted_7)
						]), pending_action.value.type === "install" ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("p", _hoisted_8, [
							_cache[17] || (_cache[17] = (0, vue.createTextVNode)(" Are you absolutely sure you want to install and trust ", -1)),
						...
						])) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("p", _hoisted_9, [
							_cache[19] || (_cache[19] = (0, vue.createTextVNode)(" Are you absolutely sure you want to update and trust the new version of ", -1)),
							(0, vue.createElementVNode)("code", null, (0, vue.toDisplayString)(pending_action.value.name), 1),
							_cache[20] || (_cache[20] = (0, vue.createTextVNode)("? ", -1))
						]))]),
						_: 1
					}, 8, ["open"])], 64);
				};
